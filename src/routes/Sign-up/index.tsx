            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default  ">
                ...
                <div class="hidden w-full xl:block xl:w-1/2">
                    ...
                    <a class="mb-5.5 inline-block" href="index.html">
                        <img class="" src="https://free-demo.tailadmin.com/src/images/logo/logo-dark.svg" alt="Logo" />
                    </a>
                ...
                <div class="w-full border-stroke  xl:w-1/2 xl:border-l-2">
                    ...
                    <form>
                        ...
                        <div class="mb-6">
                        <label class="mb-2.5 block font-medium text-black ">Re-type Password</label>
                        <div class="relative">
                        ...
                        <button
                        class="flex w-full items-center justify-center gap-3.5 font-medium rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-80 ">
                        <span>
