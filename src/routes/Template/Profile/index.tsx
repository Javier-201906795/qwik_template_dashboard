        ...
        <main>
            ...
            <div class="mx-auto max-w-242.5">
                ...
                <div class="relative z-20 h-35 md:h-65">
                    <img src="https://free-demo.tailadmin.com/src/images/cover/cover-01.png" alt="profile cover"
                ...
                <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    ...
                    <div class="relative drop-shadow-2">
                        <img src="https://free-demo.tailadmin.com/src/images/user/user-06.png" alt="profile" />
                        <label for="profile"
                    ...
                    <div class="mt-6.5">
                        <h4 class="mb-3.5 font-medium text-black" >
                        Follow me on
                        </h4>
                        <div class="flex items-center justify-center gap-3.5">
                        <a href="#" class="hover:text-primary"  aria-label="social-icon">
